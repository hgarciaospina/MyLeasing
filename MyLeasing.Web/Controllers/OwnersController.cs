...
namespace MyLeasing.Web.Controllers
{
    ...
    public class OwnersController : Controller
    {
        ...
        /* Este id corresponde a la propiedada a la que se le va asignar el contrato*/
        ...
        public async Task<IActionResult> DeleteImage(int? id)
        {
            ...
            var propertyImage = await _dataContext.PropertyImages
                // A propertyImage se le incluye la Property para poder devolverse al lugar adecuado
            ...
            await _dataContext.SaveChangesAsync();
            // Nos devolvemos a los detalles de la propiedad identificada con el Property.Id  
        ...
        public async Task<IActionResult> DeleteContract(int? id)
        {
            ...
            var contract = await _dataContext.Contracts
                // A contract se le incluye la Property para poder devolverse al lugar adecuado
